...
def example_2_multiple_data_sources():
    ...
    consumption = eptr.call("rt-consumption", start_date=date, end_date=date)
...
def example_5_generation_data():
    ...
    gen_df = eptr.call("rt-generation", start_date=date, end_date=date)
...
def example_6_error_handling():
    ...
    try:
        df = eptr.call("invalid-call-key", start_date="2024-07-29", end_date="2024-07-29")
